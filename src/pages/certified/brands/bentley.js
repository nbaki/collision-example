        ...
        <Container fluid>
          <div className="contained-text" id="space">
            <Row>
              ...
              <Col md={8}>
                <img src={BentleyPhoto1} className="in-up" id="brand-photos" alt="Bentley" />
              </Col>
              <Col md={4}>
                <img src={BentleyPhoto2} className="in-up" id="brand-photos" alt="Bentley" />
              </Col>
              <Col md={8}>
