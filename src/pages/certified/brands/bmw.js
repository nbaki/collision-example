        ...
        <Container fluid>
          <div className="contained-text cert-text" id="space">
            <Row>
              ...
              <Col md={4}>
                <img src={BMWPhoto2} className="in-up" id="brand-photos" alt="BMW" />
              </Col>
              <Col md={6}>
                <img src={BMWPhoto1} className="in-up" id="brand-photos" alt="BMW" />
              </Col>
              <Col md={6}>
              ...
              <Col md={6}>
                <img src={BMWPhoto3} className="in-up" id="brand-photos" alt="BMW" />
              </Col>
            </Row>
          </div>
        </Container>
